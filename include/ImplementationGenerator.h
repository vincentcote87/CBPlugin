#ifndef IMPLEMENTATIONGENERATOR_H_INCLUDED
#define IMPLEMENTATIONGENERATOR_H_INCLUDED
...
class ImplementationGenerator : public cbToolPlugin
{
    public:
        /** Constructor. */
        ImplementationGenerator();
        /** Destructor. */
        virtual ~ImplementationGenerator();
